...
<form class="form-fv form-horizontal" method="post" action="{{url('admin/marka/silAjax')}}" 
	data-dt-remove="true" data-dt-id="#markalarTable" data-dt-row-id="{{marka.id}}">
<div class="modal-body">
	<div class="form-body">
			<div class="col-md-12">
				"<strong>{{marka.ad}}</strong>" markası silinecek emin misiniz?
