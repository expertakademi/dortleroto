...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="{{url('admin')}}">
			<img src="{{url('backend/assets/layout/img/logodortler.png')}}" alt="logo" style="margin-top:5px;"/>
			</a>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<img alt="" class="img-circle" src="{{url('backend/assets/layout/img/avatar3_small.jpg')}}"/>
					<span class="username username-hide-on-mobile">
					{{this.sessionObj.kullaniciAdi}} </span>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="{{url('admin/pazarlama/topluEmail')}}">
							Toplu E-Mail</a>
						</li>
						<li>
							<a href="{{url('admin/pazarlama/topluSms')}}">
							Toplu SMS</a>
						</li>
					</ul>
				</li>
