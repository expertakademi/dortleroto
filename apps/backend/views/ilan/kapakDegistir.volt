<div class="modal-header">
    ...
    <h4 class="modal-title">Kapak değiştir</h4>
</div>
<form class="form-fv form-horizontal" method="post" action="{{url('admin/ilan/kapakDegistirAjax')}}">
<div class="modal-body">
	<div class="form-body">
			<div class="col-md-12">
				Bu resim kapak resmi yapılacak emin misiniz?
