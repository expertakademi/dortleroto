<div class="modal-header">
    ...
    <h4 class="modal-title">Sikayetler Sil</h4>
</div>
<form class="form-fv form-horizontal" method="post" action="{{url('admin/ilan/sikayetlerSilAjax')}}" data-dt-reload="true" data-dt-id="#sikayetlerTable">
<div class="modal-body">
	<div class="form-body">
			<div class="col-md-12">
				Bu şikayet silmek istediğinizden emin misiniz?
