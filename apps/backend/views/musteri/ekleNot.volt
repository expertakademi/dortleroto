<div class="modal-header">
    ...
    <h4 class="modal-title">Müşteri Notu Ekle</h4>
</div>
<form class="form-fv form-horizontal" method="post" action="{{url('admin/musteri/ekleNotAjax')}}" data-dt-reload="true" data-dt-id="#musteriNotlariTable">
