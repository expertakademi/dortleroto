<div class="modal-header">
    ...
    <h4 class="modal-title">Müşteri Notu Sil</h4>
</div>
<form class="form-fv form-horizontal" method="post" action="{{url('admin/musteri/silNotAjax')}}" 
	data-dt-remove="true" data-dt-id="#musteriNotlariTable" data-dt-row-id="{{musteriNot.id}}">
